...
Respond in plain text only. Do NOT use Markdown symbols such as ##, ---, **, backticks, or bullet symbols like * or -. Use simple text formatting only.

Executive Summary
One to three sentences. State what failed, probable cause, and current impact. Non-technical language.

Technical Log Analysis
Use simple dashes (-) for listing findings. Each finding must include component, observed behavior, log evidence, and interpretation.

Include at least three findings if logs permit.
...
Use numbered steps (1, 2, 3...). Each step must be actionable in under 5 minutes if possible.
